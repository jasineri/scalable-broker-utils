...
function g(a){if(null==document.getElementById(a.j)&&null!=a.h){a.i??(a.i=m('//div[text()="Handelsplatz"]/following-sibling::*')?.textContent);a.m=m('//div[text()="Beauftragte St\u00fcckzahl"]/following-sibling::*')?.textContent;a.l=m('//div[text()="Limitpreis"]/following-sibling::*')?.textContent;let b=document.createElement("button");b.addEventListener("click",()=>h(a,"//button[contains(node(), 'Schlie\u00dfen')]",0));b.innerText=a.j;b.id=a.j;a.h.parentElement.appendChild(b)}}
...
class n{constructor(){this.j="Resell";this.i="European Investor Exchange (EIX)";this.l=this.m=null;this.g=0;this.h=null;this.o=void 0;MutationObserver=window.MutationObserver;(new MutationObserver(()=>{c(this)})).observe(document,{subtree:!0,childList:!0,attributes:!0})}}new n;
