...
// ==/UserScript==
function d(a){e(a);clearTimeout(a.m);a.m=setTimeout(()=>{e(a);null!=a.h&&(a.g=0,g(a))},1E3);switch(a.g){case 0:g(a);break;case 1:h(a,"//button//span[not(@disabled) and (text()='V' or contains(text(), 'Verkaufen'))]",1);break;case 2:h(a,"//div[text()='St\u00fcckzahl']",2,()=>k(a,()=>document.execCommand("insertText",!1,a.l),3,()=>h(a,"//button//*[contains(text(), 'Order vorbereiten')]",4)));break;case 5:h(a,"//input[@id='limit-price-checkbox']",5,()=>k(a,()=>document.execCommand("insertText",!1,a.j),
