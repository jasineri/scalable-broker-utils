...
6))}}function f(a){a.h=m('//div[text()="Order abgelaufen"]')}function g(a){if(null==document.getElementById(a.i)&&null!=a.h){a.l=m('//div[text()="Beauftragte St\u00fcckzahl"]/following-sibling::*')?.textContent;a.j=m('//div[text()="Limitpreis"]/following-sibling::*')?.textContent;let b=document.createElement("button");b.addEventListener("click",()=>h(a,"//button[contains(node(), 'Schlie\u00dfen')]",0));b.innerText=a.i;b.id=a.i;a.h.parentElement.appendChild(b)}}
