...
function f(a,b){let c=document.createElement("button");c.addEventListener("click",()=>h(a,"//button//*[contains(text(), 'Schlie\u00dfen')]",1));c.innerText=a.h;c.id=a.h;b.parentElement.appendChild(c)}function h(a,b,c){setTimeout(()=>{let g=e(b);null!=g&&(a.g=c,g.click())},100)}function k(a,b,c){setTimeout(()=>{b();a.g=c},100)}
